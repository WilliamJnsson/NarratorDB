...
VERIFIER_PATH = (
    REPOSITORY
    / "benchmark_records/reproduction-v13-paid-paired-scoring-r2-20260716/verify_dynamic_admission.py"
)
...
class DynamicAdmissionMutationTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        shutil.copy2(
            REPOSITORY
            / "benchmark_records/reproduction-v13-paid-paired-scoring-r2-20260716/verify_evaluator_ledger.py",
            self.ledger_verifier,
        )
        self.telemetry_capture = self.revision / "capture_provider_telemetry.py"
        shutil.copy2(
            REPOSITORY
            / "benchmark_records/reproduction-v13-paid-paired-scoring-r2-20260716/capture_provider_telemetry.py",
            self.telemetry_capture,
        )
        self.fx_capture = self.revision / "capture_ecb_fx.py"
        shutil.copy2(
            REPOSITORY
            / "benchmark_records/reproduction-v13-paid-paired-scoring-r2-20260716/capture_ecb_fx.py",
            self.fx_capture,
        )
        self.harness_guard = self.revision / "run_harness_guarded.py"
        shutil.copy2(
            REPOSITORY
            / "benchmark_records/reproduction-v13-paid-paired-scoring-r2-20260716/run_harness_guarded.py",
            self.harness_guard,
        )
    ...
    def _write_requirements(self) -> None:
        document = {
            "schema_version": "narratordb.v13-paid-dynamic-admission-requirements.v2",
            "predecessor": {
...
class HardenedWrapperMutationTests(unittest.TestCase):
    def test_static_closed_tree_and_guarded_runtime_controls_are_present(self) -> None:
        wrapper = (
            REPOSITORY
            / "benchmark_records/reproduction-v13-paid-paired-scoring-r2-20260716/run_paid_variant_hardened.sh"
    ...
    def test_arbitrary_variant_tuple_is_rejected_before_key_or_proxy(self) -> None:
        wrapper = (
            REPOSITORY
            / "benchmark_records/reproduction-v13-paid-paired-scoring-r2-20260716/run_paid_variant_hardened.sh"
        )
