...
V7_RUN="reports/longmemeval-intelligence-dev42-v13-paid-paired-scoring-r2-20260716/attempt1/v7-control"
V7_PROJECT="narratordb-intelligence-dev42-v7-gpt54mini"
V13_RUN="reports/longmemeval-intelligence-dev42-v13-paid-paired-scoring-r2-20260716/attempt1/v13-first"
...
# Retain the credential only long enough to transfer it to the isolated proxy
# subprocess.  Every verifier, harness, logger, and child other than that proxy
# is explicitly launched with the provider credential removed.
RUNTIME_OPENROUTER_KEY=$OPENROUTER_API_KEY
unset OPENROUTER_API_KEY

RUN_ABSOLUTE="$ROOT/$RUN"
V11_SOURCE="$ROOT/reports/longmemeval-intelligence-dev42-v13-paid-paired-scoring-r2-20260716/attempt1/tools/v11-source"
HARNESS_SOURCE="$ROOT/reports/longmemeval-intelligence-dev42-v13-paid-paired-scoring-r2-20260716/attempt1/tools/harness-source"
HARNESS_GUARD="$SCRIPT_DIR/run_harness_guarded.py"
HARNESS_SITE_PACKAGES="$ROOT/reports/longmemeval-intelligence-dev42-v13-paid-paired-scoring-r2-20260716/attempt1/tools/harness-site-packages"
...
# The real provider credential is inherited only by this proxy subshell.  The
# harness and all admission tooling have already run with the key removed.
(
  trap - INT TERM
  exec env -i \
    LANG=C \
    ...
    "$ROOT/.venv/bin/python" -P -S -B -m narratordb.benchmarks.openrouter_proxy \
    --host 127.0.0.1 \
    --port 8890 \
