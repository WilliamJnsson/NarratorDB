...
REQUIREMENTS_SCHEMA = "narratordb.v13-paid-dynamic-admission-requirements.v3"
...
def _variant_map(requirements: Mapping[str, Any]) -> dict[str, Mapping[str, Any]]:
...
def _verify_ledger_identity_audit(
    ...
    *,
    ...
    document, payload = _load_json(audit_path, label=f"{label} identity audit")
...
def _authorization_document(
    ...
    *,
    ...
    variants = _variant_map(requirements)
