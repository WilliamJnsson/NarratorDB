...
V7_RUN="reports/longmemeval-intelligence-dev42-v13-paid-paired-scoring-r3-20260716/attempt1/v7-control"
V7_PROJECT="narratordb-intelligence-dev42-v7-gpt54mini"
V13_RUN="reports/longmemeval-intelligence-dev42-v13-paid-paired-scoring-r3-20260716/attempt1/v13-first"
...
V11_SOURCE="$ROOT/reports/longmemeval-intelligence-dev42-v13-paid-paired-scoring-r3-20260716/attempt1/tools/v11-source"
HARNESS_SOURCE="$ROOT/reports/longmemeval-intelligence-dev42-v13-paid-paired-scoring-r3-20260716/attempt1/tools/harness-source"
HARNESS_GUARD="$SCRIPT_DIR/run_harness_guarded.py"
HARNESS_SITE_PACKAGES="$ROOT/reports/longmemeval-intelligence-dev42-v13-paid-paired-scoring-r3-20260716/attempt1/tools/harness-site-packages"
