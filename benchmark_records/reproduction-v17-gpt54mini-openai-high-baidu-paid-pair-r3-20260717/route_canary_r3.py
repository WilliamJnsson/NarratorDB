#!/usr/bin/env python3
"""Final pre-score route probe with a fixed inter-provider pacing gap."""
...
CASES = (
    (
        ...
        "openai/gpt-5.4-mini",
        {
            "messages": [{"role": "user", "content": "A shop has 17 boxes with 19 items each. Reply with only the total."}],
            "max_tokens": 128,
        },
    ),
    (
...
def main() -> int:
    ...
    document = {
        ...
        "complete": True,
        "inter_provider_delay_seconds": 5,
        "calls": observations,
